...
| **통합 HQ 대시보드(다지점)** | ✅ | △ | △ | △ | ❌ | **ogada 차별화** — 경쟁사 공개 자료 미확인 |
| **청구 — 내부 수가·명세 계산** | ✅ | ✅ | ✅ | ✅ | △ | ogada fee_schedules B방식 |
| **청구 — 공단 포털 전송** | ❌ MVP제외 | △(롱텀 UI) | △ | △ | ✅ | 공단 공식 |
| **청구 — 공단 엑셀 import** | ✅ | ✅ | ✅ | △ | ✅ export | [케어포 매뉴얼](https://www.carefor.co.kr/ct_att/contents_article/0/202206/12/Dov8rzFqBv.pdf); [이지케어 fnc](https://ezcare.easyms.co.kr/new/ezCare_fnc.html) |
...
|------|-------|--------|----------|------|
| 공개 이용자/기관 수 | — (신규) | 14,000+ 기관 | 9,138 재가(2026.05) | — |
...
| 우선순위 | 갭 | MVP | 후속 |
|----------|-----|-----|------|
| 🔴 | NHIS 엑셀 **실컬럼**·reconciliation UX | △ 스키마 있음 | 파일럿 샘플 |
...
| 항목 | 값 |
|------|-----|
| **마지막 전체 갱신** | **2026-06-06** |
| **조사 에이전트** | benchmark_researcher |
| **입력 문서** | REQUIREMENTS §1-5, PLAN_NOTES, USER_STORIES |
| **다음 조사 우선** | ① NHIS 엑셀 샘플 ② 케어포 주야간 메뉴 트리 ③ 이지케어 주간보호 전용 ④ 다지점 사례 ⑤ ogada 가격 정책 |
