<!-- doc:owner=DBA doc:audience=COD,PLN,TSR updated=2026-06-17T13:00:00+09:00 -->
...
| 배차 운영 메타 | `clients.desired_boarding_time`·`desired_dropoff_time`(V146)·`default_pickup_time`(V47 레거시) | 비PII 운영 시각 — 이용자 기본정보 cohort와 동일 보존 |
