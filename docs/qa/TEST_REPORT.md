...
> **CURRENT BASELINE**: backend develop `dfd9be2` (v3 meals/programs API, +1 vs `53a1ffe`) · frontend test `c510f5c` (v1.2 merged) · frontend develop `362dbf0` (v1.3-A/v3 UI shell + v3 a11y + v3 pilotPageFlows E2E US-N01·N02)
