...
> **작성**: tech_writer 에이전트  
> **최초 작성일**: 2026-06-05  
> **최종 갱신**: 2026-06-06 (V35·수가표·QR actor backstop 반영)  
> **상태**: 초안 (Draft)  
...
## [Unreleased] — MVP v1 개발 중 (2026-06-06 V35 업데이트)
...
| Must 업무 화면 (프론트) | **미구현** | `/clients`, `/attendance`, `/health`, `/billing`, `/guardian/checkin` 등 — API만 동작. FAQ Q77 참고 |
