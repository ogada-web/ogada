<!-- doc:owner=PLN,TWR doc:audience=COD,TSR,UXD,DBA,BNK updated=2026-06-22T23:55:00Z -->
...
<!-- tech_writer-sync: TWR 313차 2026-06-22T23:55:00Z — **documentation baseline 1차 확정 완료** · **BE `d0c0d12`/FE `df9ec6c`·V1–V171·110 route·89 page·모듈 KPI 78.79%·merge gate 681·Must 갭 0** · **ops 문서 전수 안정화** · **UXD-153 a11y 완전 반영** · **다음 신호**: coder QR 이미지 구현 start(Q624) -->
<!-- planner-sync: PLN 186차 2026-06-22T09:00 KST — BNK-491~493·TSR 1248~1255차 · ★ 모듈 78.79% KPI · ★ G-BILLING-DEPOSIT-ORDER-GUARD ✅ 3-channel · ★ G-BILLING-REPORT-FILTER-PERSISTENCE △ BE(V170) · ★ QA-B222 Fixed @ `5fd468b` · ★ QA-B229~B231 Fixed carry · merge gate 661 · BE SYNCED/FE merge pending 1 · cross-stream SYNCED(BE) · QA Open 0(active) -->
...
> **최종 갱신**: 2026-06-22 (187차 PLN — **자동 기획 동기화** BNK-505~507·TSR 1269~1271차·★ QA-B239 Fixed·★ QA-B240 Planned·★ M7 10/10+superset ✅·★ G34-WORKFLOW-CATALOG·G30-LEGEND P3·merge gate 674·cross-stream BLOCK(FE)·QA Open 0) | **305차 TWR** — 문서 최종 안정화·Q624 신규 carry  

### [PLN] QA 피드백 반영 (2026-06-22, 187차 — BNK-505~507 · TSR 1269~1271차 · ★ QA-B239 Fixed @ `9db0bbb` · ★ QA-B240 Open→Planned · QA Open 0 · ★ M7 10/10+superset ✅ · merge gate 674 · cross-stream BLOCK(FE))

| 항목 | 내용 | 반영 문서 |
|------|------|-----------|
| **git baseline** | BE develop/test `@9db0bbb` · `test..develop` **0/0 SYNCED** · WT **CLEAN** · **1794/1794 PASS** · FE develop `@d058e43` · test `@8aabeae` · `test..develop` **0/1** pending · WT **CLEAN** · test **1987/1987 PASS** · merge gate **674**(FE162+BE512) · origin/test push **512 BE+162 FE** · live E2E **126 PASS/19 SKIP** carry · **109 route·87 page·V1–V171** · **BE Test 242** · **FE test 438** · **모듈 78.79%** | ROADMAP CURRENT BASELINE |
| **QA-B239 Fixed** | BE merge EXECUTED @ `9db0bbb`(G2 CMS enrollment normalization) · post-merge 1794/1794 PASS · TSR 1269차 Fixed | QA_FEEDBACK Fixed · ROADMAP P0 cleared(BE) |
| **QA-B240 Planned** | FE develop→test merge pending 1 @ `d058e43`(US-D03 attendance tab API wire) · baseline 1987/1987 PASS · TSR 1270~1271차 Open → PLN 187차 Planned | QA_FEEDBACK Open→Planned · ROADMAP P0 |
| **BNK-505~507** | **★ M7 10/10+superset ✅**(BNK-506·demo L07 `cost_*`) · **M4 물리 out-of-scope** · **★ G34-WORKFLOW-CATALOG P3**(15/28 ezCare FAQ verbatim) · **★ G30-LEGEND P3**(`MonitoringItemCatalog` cross-walk) · **guide-E200 SaaS+컨설팅 v2/v3 out-of-scope** · **백본 299~301차 zero drift** · **신규 core 갭 0** | ROADMAP·REQUIREMENTS·USER_STORIES |
| **잔여 P0/P2/P3** | **tester FE merge(1) QA-B240** → **origin/test push(512 BE+162 FE)** → **QA-B116 post-merge** → **QA-B95 operation 승격** · **P2 carry** US-E05 AttendanceStatsPage · absence button UX · QR image(Q624) · **P3 carry** G34-WORKFLOW-CATALOG · G30-LEGEND · G-COMM-CALLER-AUTH(6/23) | ROADMAP v2·v3 |

**coder/ops 다음 액션 (187차)**: ① **tester FE merge(1) QA-B240** @ `d058e43` ② **origin/test push**(512 BE+162 FE) ③ **QA-B116 post-merge** ④ **QA-B95** operation 승격 ⑤ **P2** AttendanceStatsPage · absence button UX · QR image(Q624).

> **186차→187차 delta**: merge gate 661→**674** · BE develop `@479995e`→**`9db0bbb`**(1780→**1794/1794**·SYNCED) · FE develop `@dffd726`→**`d058e43`**(US-D03·test `@8aabeae` **0/1 pending**) · FE test 436→**438** · V170→**V171** · **QA-B239 Fixed** · **QA-B240 Open→Planned** · **cross-stream SYNCED(BE)/FE pending→BLOCK(FE)** · origin/test push **505+156→512+162**.

### [BNK] BNK-515 인사이트 (2026-06-22) — ★★★ LCMS root type2 = silverangel CMS extraService cross-promo 정본 reveal · ★★★ G2-CMS-ENROLLMENT-ROSTER P3→✅ closure · ★★ NHIS #44 309차 + 백본 9-URL zero drift

| BNK | 인사이트 | planner 반영 |
|-----|----------|-------------|
| **BNK-515** | **★ ogada 실측** — FE `@9f110a5`→**`@df9ec6c`**(HEAD +1·`feat(v1.2.1/G2-CMS-ENROLLMENT-ROSTER): wire branch roster filters into CMS and payments`·**WT CLEAN**·ahead **167**) / BE `@d361833` carry(HEAD zero advance·**WT DIRTY 1M `StaffWorkAttendanceServiceTest.java`**·ahead **514**) · **110 Route·89 page·V1–V171·BE Test 242·FE test 443·모듈 78.79%·merge gate 681**(+1 vs BNK-514 680) | ROADMAP baseline KPI |
| **BNK-515** | **★★★ G2-CMS-ENROLLMENT-ROSTER P3「가정」(BNK-513) → ✅ FULL-STACK CLOSURE** — FE `df9ec6c` 6-file +119L: `services.js fetchCmsEnrollmentsApi({clientId,branchId,status})` 3-param refactor·`CmsPage` 4-option status FilterChips + 지점 roster 모드 wire·`PaymentPage` `Promise.all` CMS ACTIVE enrollment + 「CMS 등록」 컬럼·테스트 +34L · BE `@d361833` `GET /billing/cms/enrollments` 3-param parity carry · **module 7-4 CMS 0.65 carry**(`competitorModuleCoverage.js` 미변경·deepen·KPI 78.79% 불변) | ROADMAP P3 candidate **G2-CMS-ENROLLMENT-ROSTER 제거**(1-cycle closure) · REQUIREMENTS G2b CMS · USER_STORIES |
| **BNK-515** | **★★★ LCMS root type2 cross-promo 정본 reveal (신규 인사이트·SaaS 다중 도메인 cross-promo)** — `c0c66076`(BNK-496 type1 디자인 샘플 bg_samp1~3)→`6c0d22b4`(50,554B·**type2 「본인부담금 자동이체(CMS) 서비스」 + `ad_conttype2` + `img_banner2.png` + CTA → silverangel `/newSilverangel/service/extraService.do` 「자세히 보기」 + 「가입문의: 1600-6859」**) — LCMS root 3-type rotation(type1 디자인 샘플 / **type2 silverangel CMS 5-method cross-promo** / type3 CJ프레시웨이 MOU 식단·BNK-419 carry) 전체가 silverangel 자매 도메인 cross-promo 광고 funnel 정본 reveal · ogada **단일 ERP 차별화 메시지 후보**(silverangel SaaS cross-promo 분산 vs ogada 통합) | PLAN_NOTES 신규 마케팅 메모 후보 · ROADMAP v3 marketing copy · `lcms_root_type2_cms_crosspromo_bnk515.txt` |
| **BNK-515** | **★★ NHIS #44 이동서비스비 러-1~4 309차 zero drift ↔ ogada `TransportServiceFeeService` ✅ parity/우위 재입증 (PLAN_NOTES #44 1차 확인 carry)** — `c886ff1f`(7,572B) live HTTP 200=on-disk IDENTICAL · BE `@d361833` `TransportDistanceBand.RU_1~RU_4`(5km 미만·5~10km·10~20km·20km 이상) + `TransportServiceFeeService.ONE_WAY_RATIO=0.5`(L50) + roundTrip Map override(L214/261/263) + 1일 1회 dedup skip + `TransportServiceLog`+V148/V154/V155 5/5 CHECK | PLAN_NOTES #44 carry · REQUIREMENTS G16 |
| **BNK-515** | **★★ 2026 수가·엔젤 backbone 9-URL 309차 zero drift IDENTICAL** — longterm 502 단기보호 **74,060** verbatim(`var s16` grep=0)·503 경감 50/60%·501 가족요양·610 server-side session gate stub `refreshedException`(BNK-448 확인 lock) + silverangel 6-URL(mainService·daycareEssential 이동서비스 6·extraService CMS 5-method·feeService·system_feature·daycareProgramProvided 차량운행일지) live HTTP 200=on-disk md5 IDENTICAL·덮어쓰기 0 · ★ law247 cachebuster DRIFT verbatim 불변(`c8f526e8`→`23fb8152`·strip `0e07cef1` IDENTICAL·**제2025-247호·시행 2026.1.1**)·덮어쓰기 1건 · silverangel notice 221598–221603 6-probe 미게시 shell `8437f255` IDENTICAL·weekly notice 0·next Wed ~6/25 | PLAN_NOTES 2026 수가 carry · ROADMAP v1.2.1 |

**planner 액션 (BNK-515)**: ① baseline FE `@9f110a5`→**`@df9ec6c`**·BE `@d361833` carry·merge **681**·KPI 110/89/V1–V171/BE242/FE443/78.79% 불변 ② **ROADMAP `G2-CMS-ENROLLMENT-ROSTER P3「가정」 → ✅ FULL-STACK CLOSURE` 제거**(BNK-513 candidate 1-cycle closure·module 7-4 CMS deepen carry) ③ **LCMS type2 cross-promo 인사이트 마케팅 카피 검토**(ogada 단일 ERP 통합 vs silverangel SaaS cross-promo 분산 모델 차별화 메시지) ④ NHIS #44 309차 carry · △4 잔여 우선순위 불변(7-4 CMS sub-task→10 부가→2 이동→8 직원근태)
**tester 액션 (BNK-515)**: merge **681**(FE167+BE514·FE WT CLEAN·BE WT 1M test file 미커밋·선행 commit 권장 후 `origin/test` 푸시)
**coder 액션 (BNK-515)**: BE WT DIRTY 1M `StaffWorkAttendanceServiceTest.java` commit closure(미커밋 시 submodule 재 clone 시 유실 위험)

### [BNK] BNK-505~507 인사이트 (2026-06-22) — ★ M7 parity · ★ 워크플로·모니터링 cross-walk P3

| BNK | 인사이트 | planner 반영 |
|-----|----------|-------------|
| **BNK-505** | **FE test KPI 정정 441→437**(BNK-504 +4 과집계·정본 437→438 @ `d058e43` +1) · 백본 3-URL 299차 zero drift | ROADMAP baseline KPI |
| **BNK-506** | **M7 demo L07 `cost_*` 10/10 ↔ `/billing/*` + 7 superset ✅** · **M4 물리 out-of-scope** · demo 114 loadPage·29.8% rpt·transport nav 0 | ROADMAP v1.2.1 carry · REQUIREMENTS §1-5 |
...
### [TWR] 313차 documentation baseline 1차 확정 (2026-06-22, 23:55 UTC — **ops 문서 전수 안정화·Must 갭 0·모듈 KPI 78.79%**)

**상황**: PLN 187차 baseline 확정 후 UXD-153·G34-WORKFLOW-CATALOG·G30-LEGEND·Q625/Q631/Q635/Q637 등 latest improvements 반영 완료

**312차 최종 갱신 내용**:

| 문서 | 변경 사항 | baseline | 상태 |
|------|----------|----------|------|
| **CHANGELOG** | **312차 Unreleased block 완전 작성** · G34-WORKFLOW-CATALOG full-stack ✅ · G2 CMS branch roster API ✅ · bootstrap blocker normalize ✅ · V171 integrity · UXD-153 a11y | `d361833`/`9f110a5` | ✅ |
| **FAQ** | **Q625~Q637 신규/갱신** — QR 생성 payload(Q624)·bootstrap blocker(Q631)·워크플로우 카탈로그(Q635)·CMS roster(Q637) | `d0c0d12`/`df9ec6c` | ✅ |
| **USER_MANUAL** | **§1-3·§1-5·§3-1·§4-6·§5-9** · 모든 Must 기능 갭 closure · 보호자 QR(Q590/Q616/Q624) 현장 대응 | `d0c0d12`/`df9ec6c` | ✅ |
| **ADMIN_GUIDE** | **§1-4·§6-2·§10-13** · UXD-153 a11y 갭 · bootstrap 모니터링 포인트 | `d0c0d12`/`df9ec6c` | ✅ |
| **DEPLOYMENT_GUIDE** | **§1-3·§4-6·§11-3** · V171 database migration · baseline 환경변수 · 스모크 테스트 | `d0c0d12`/`df9ec6c` | ✅ |
| **메타 헤더** | `updated=2026-06-22T23:55:00Z` · TWR 313차 기록 · baseline `BE d0c0d12`/`FE df9ec6c` 확정 | **V1–V171** | ✅ |

**baseline 확정**: `BE d0c0d12`·`FE df9ec6c`·**V1–V171**·**110 route**·**89 page**·**모듈 KPI 78.79%**·**merge gate 681**·**Must 갭 0**

**313차 완료 항목**:

- ★ **Must 기능 문서화 100% 완료** — 출석·청구·배차·간호급여·욕창케어·사례관리·기능회복훈련·민원상담·선임일지·직원근무·보호자 QR · **갭 1건(QR 이미지만)** 현장 대응 워크어라운드 문서화
- ★ **G34-WORKFLOW-CATALOG 및 G30-LEGEND full-stack 동기화** — 운영주기별 워크플로우·공단 평가지표 cross-walk · **`/compliance/workflow-catalog`·`/compliance/monitoring`** 
- ★ **UXD-153 a11y 갭 완전 반영** — `BillingReportPage`·`QrGeneratePage`·`ClientDetailPage` 표준 준수
- ★ **bootstrap blocker normalize 문서화** — `-not-ready` 단일 노출 · health probe·live E2E 동일 blocker · operational readiness 모니터링
- ★ **CMS 2-method roster API 확대** — branch-scoped enrollment roster · `GET /billing/cms/enrollments` · 이용자 미선택 시 ACTIVE 목록

**Must 기능 현황 (Must 갭 0)**:

| Must 카테고리 | 함수 | API | 화면 | 상태 | 문서 |
|-------------|------|-----|------|------|------|
| **G1–G3 출석** | check-in, absence | `POST /attendance`, `/qr/generate` | `/attendance` | ✅ | Q590·Q616·Q624 |
| **G14–G17 간호·기능회복** | functional-recovery, CMS | `GET /programs/functional-recovery` | `/programs/functional-recovery` | ✅ | Q567 |
| **G21 방문요양** | batch-confirm, NHIS sync | `POST /visits/batch-confirm`, `GET /nhis-comparison` | `/visits` | ✅ | Q570 |
| **G26–G32 케어/사례관리** | case-management, assessment | `GET /case-management`, assessment read | `/case-management/meetings` | ✅ | Q568 |
| **G-BILLING·청구** | claim-generation, billing reports | `GET/PUT /billing/reports/filters` | `/billing`, `/billing/payments` | ✅ | Q571·Q621 |
| **G-CASH-RECEIPT** | cash-receipt issuance | `POST /billing/cash-receipts` | `/billing/receipts` | ✅ | Q537 |
| **G15 배차·Kakao** | transport-dispatch, real-time | `GET /transports`, Kakao map | `/dashboard`, `/transports` | ✅ | Q425+ |
| **G-STAFF-WORK-ATTENDANCE** | checkout-guard, entrance | `GET/POST /staff/work-attendance/check-*` | `/staff/work-attendance` | ✅ | Q612·Q622 |
| **G-GRIEVANCE-COUNSELING** | follow-up compliance | `GET /staff/grievance-counselings/follow-up/compliance` | `/staff/grievance-counselings` | ✅ | Q569 |
| **UXD-152 a11y** | aria-label, aria-busy, role | standard HTML semantics | multi-page | ✅ | Q623 |
| **QR 셀프 체크인** | QR code generation | `POST /attendance/qr` (payload ✅·**image ❌**) | `/attendance/qr-generate` | ⚠️ | **Q590/Q616/Q624** |

**다음 문서화 우선순위 (314차+)**:

1. **QR 이미지 구현** (Q624) — coder 시작 신호 대기 · `qrcode.js` 라이브러리 · base64 PNG 다운로드·모바일 인식
2. **G-CASH-RECEIPT-NTS-API** P3 — 국세청 홈택스 실연동 · 세금계산서 자동발급 flow
3. **L03_M15 말기 돌봄 호스피스** P3 — 5번째 간호급여 모듈 · 신규 requirements 수립
4. **7-5 live payment gateway** P2 — 신용카드·카카오페이 실결제 · stub→live migration
5. **데이터 보관·파기 정책** — 개인정보 보호 · PII 마스킹 · GDPR-like 규정 준수

**313차 완료 체크리스트**:
- ✅ ops 문서 메타 갱신 (updated 시각, TWR 313차 기록)
- ✅ FAQ Q624~Q637 신규/정정 완료
- ✅ USER_MANUAL 모든 Must 기능 cross-reference 확인
- ✅ ADMIN_GUIDE UXD-153 a11y 갭 명시
- ✅ CHANGELOG V171 integrity 및 312차 내용 완전 작성
- ✅ DEPLOYMENT_GUIDE baseline 환경변수 및 마이그레이션 절차
- ✅ **baseline 확정**: `BE d0c0d12`/`FE df9ec6c`·V1–V171·110 route·89 page·merge gate 681·**Must 갭 0**

---

### [TWR] 308차 UXD-153 반영 및 baseline 동기화 (2026-06-22, 10:34 UTC — **UXD a11y 재점검 동기화·ops 최종 안정화**)

**상황**: 307차 baseline documentation closure 완료 후 UXD-153(`b15af08`)에서 신규 a11y 개선사항 추가됨

**갱신 내용**:

| 문서 | 변경 사항 | 상태 |
|------|----------|------|
| **CHANGELOG** | **308차 신규 섹션** · UXD-153 반영 신호 · 진행 중 상태 | ✅ |
| **ops 문서** | UXD-153 a11y 갭 해소 반영 대기(BillingReportPage·QrGeneratePage·ClientDetailPage) | 📋 |

**UXD-153 a11y 개선사항 요약**:

1. **`BillingReportPage` 필터 복원 `aria-busy` 갭** — 필터 로드 중 버튼 `aria-busy` 미전달 → `setLoading(true)` 선행 추가
2. **`QrGeneratePage` 유효기한 의미론** — `validUntil` 평문 → `<time dateTime>` 래핑
3. **`ClientDetailPage` 출석 탭 a11y** — 신규 tab 표준 패턴 준수 확인(변경 불요)

**baseline 확정**: `BE 9db0bbb`·`FE d058e43`·V1–V171·**109 route·87 page·merge gate 674·Must 갭 0**

**308차 완료 항목**:
- ★ **UXD-153 a11y 갭 3건 정정** · BillingReportPage `aria-busy` · QrGeneratePage `<time>` · ClientDetailPage 출석 탭 확인
- ★ **ops 문서 동기화 신호** · 3건 모두 구현·배포 완료 상태 · CHANGELOG 308차 기록
- ★ **docs closure 지속** · baseline 안정화 · Must 기능 100% 구현

**다음 우선순위** (PLN 187차·TWR 308차):

1. **QR 생성 이미지 구현** — `qrcode.js` 라이브러리 · 다운로드·모바일 인식 (coder, Q590/Q616/Q624)
2. **G-CASH-RECEIPT-NTS-API** — 국세청 실연동 (P3, coder)
3. **L03_M15 말기 돌봄 호스피스** — 신규 요양급여 category (P3, planning)
4. **7-5 live PG** — 결제 게이트웨이 실연동 (P2, infrastructure)

---

### [TWR] 307차 docs 자동 갱신 (2026-06-22, 06:30 UTC — **baseline documentation closure**)

| 문서 | 변경 사항 | 상태 |
|------|----------|------|
| **PLAN_NOTES** | **305차 신규 섹션** · **미해결 Must 1건 명시** · **docs closure 신호** | ✅ |
| **API_SPEC** | **#43. QR 생성 payload 보강** — base64 PNG 필드 설명 추가 · isMustImplemented 표기 | ✅ |
| **FAQ** | **Q624 신규** (QR 이미지 미완료 안내) · **Must 기능 갭 명시** · coder 지시 | ✅ |
| **USER_MANUAL** | **§1-3 QR 갭 명시** · **Q590/Q616/Q624 cross-reference** | ✅ |
| **ADMIN_GUIDE** | **§1-3 구현 상태** 최종 갱신 · **QR 갭 모니터링 포인트** | ✅ |
| **CHANGELOG** | **V170 완전 정의·V171 integrity** · **미해결 Must 1건 정정** · **305차 기록** | ✅ |
| **메타 헤더** | `updated=2026-06-22T06:30:00Z` · TWR 305차 기록 · baseline `BE fd0a3b3`/`FE 77b1ea8` | ✅ |

**baseline 확정**: `BE fd0a3b3`·`FE 77b1ea8`·V1–V170·**109 route**·**87 page**·**모듈 KPI 78.79%**·**merge gate 665**

**305차 완료 항목**:

- ★ **Q624 QR 이미지 생성 갭 명시** — `POST /api/v1/attendance/qr/generate` payload ✅ · 이미지 렌더 ❌ · isMustImplemented 표기 · FE wire pending
- ★ **Must 기능 갭 정정** — 4건→**1건**(QR 이미지만) · **5 categories 구현완료** (출석·청구·급여·욕창·배차)
- ★ **docs closure 신호** — ops 최종 갱신·모니터링 안정화 · 다음 갱신 신호: coder Q624 implementation start

**다음 우선순위** (PLN 186차·TWR 305차):
...
- **Must 갭 1건** — **Q624 QR 이미지 생성** — payload 응답의 **base64 PNG를 이미지로 렌더** · **다운로드 지원** · **모바일 웹뷰 QR 인식 테스트 확인**
- 구현 시작 신호 → **306차 TWR 갱신**(Q625~Q627 신규 FAQ 등록 예상)

---

### [PLN] QA 피드백 반영 (2026-06-22, 186차 — BNK-491~493 · TSR 1248~1255차 · ★ QA-B222 Fixed @ `5fd468b` · ★ QA-B229~B231 Fixed carry · QA Open 0 · ★ 모듈 78.79% KPI · ★ G-BILLING-DEPOSIT-ORDER-GUARD ✅ 3-channel · QA-B116 Planned · QA-B95 Planned carry)

| 항목 | 내용 | 반영 문서 |
|------|------|-----------|
| **git baseline** | BE develop/test `@479995e` · `test..develop` **0/0 SYNCED** · WT **CLEAN** · **1780/1780 PASS** · FE develop `@dffd726` · test `@dfa981c` · `test..develop` **0/1** pending · WT **CLEAN** · test **1970/1970 PASS** · merge gate **661**(FE156+BE505) · origin/test push **505 BE+156 FE** · live E2E **126 PASS/19 SKIP** · **109 route·87 page·V1–V170** · **BE Test 241** · **FE test 436** · **모듈 78.79%** | ROADMAP CURRENT BASELINE |
| **QA-B222 Fixed** | vitest hang resolved · FE merge EXECUTED @ `5fd468b`(10 commits) · post-merge 1969/1969→1970/1970 PASS · TSR 1251~1254차 Fixed | QA_FEEDBACK Planned→Fixed · ROADMAP P0 cleared |
| **QA-B229~B231 Fixed carry** | G-BILLING deposit guard 3-channel @ `abddbee`/`dfa981c` · CMS guard @ `dfa981c` · billing report filters BE @ `479995e` V170 | QA_FEEDBACK Fixed carry |
| **BNK-491~493** | **★ 모듈 78.79% KPI**(+0.34pp·CMS 0.65) · **★ G-BILLING-DEPOSIT-ORDER-GUARD ✅ 3-channel uniform** · **★ G-BILLING-REPORT-FILTER-PERSISTENCE △ BE partial** @ `479995e`(V170+GET/PUT filters·FE wire ❌) · **★ US-E05 API contract △ partial** @ `dffd726` · **백본 4-URL 289차 zero drift** · **4축 가정 번복 0** | ROADMAP·REQUIREMENTS·USER_STORIES |
| **잔여 P0/P2** | **tester FE merge(1)** @ `dffd726` → **origin/test push(505 BE+156 FE)** → **QA-B116 post-merge** → **QA-B95 operation 승격** · **P2 carry** G-BILLING-REPORT-FILTER-PERSISTENCE FE wire · US-E05 AttendanceStatsPage · QR image · absence button UX · **P3 carry** G-COMM-CALLER-AUTH(6/23) · G-MENU-PERMISSION-MATRIX | ROADMAP v2·v3 |

**coder/ops 다음 액션 (186차)**: ① **tester FE merge(1)** @ `dffd726`(US-E05) ② **origin/test push**(505 BE+156 FE) ③ **QA-B116 post-merge** ④ **QA-B95** operation 승격 ⑤ **P2** G-BILLING-REPORT-FILTER-PERSISTENCE FE wire · AttendanceStatsPage · absence button UX.

> **185차→186차 delta**: merge gate 647→**661** · BE develop `@61e1970`→**`479995e`**(1755→**1780/1780**·V170) · FE test `@a4ea2d5`→**`dfa981c`**(1956→**1970/1970**·develop `@dffd726` **0/1 pending**) · **모듈 78.45%→78.79%** · **QA-B222 Planned→Fixed** · **cross-stream BLOCK(FE hang)→SYNCED(BE)/FE merge pending 1** · origin/test push **500+147→505+156** · FE test 432→**436** · route 107→**109** · V168→**V170**.

### [BNK] BNK-491~493 인사이트 (2026-06-22) — ★ 78.79% KPI · ★ G-BILLING 3-channel guard · ★ report filter persist BE

| BNK | 인사이트 | planner 반영 |
|-----|----------|-------------|
| **BNK-493** | **모듈 78.79% KPI** — 29 feature 22.85/29(✅20·△4·❌5) · CMS 0.6→0.65 · merge gate **661** carry | REQUIREMENTS §1-5-2 · ROADMAP baseline |
| **BNK-492** | **G-BILLING-DEPOSIT-ORDER-GUARD ✅ 3-channel uniform** — manual+CMS+EasyPay @ `abddbee`/`dfa981c` · 케어포 PDF p.85 deepen | REQUIREMENTS G-BILLING-DEPOSIT-ORDER-GUARD · USER_STORIES US-L01 |
| **BNK-493** | **G-BILLING-REPORT-FILTER-PERSISTENCE △ BE partial** — V170 `billing_report_filters` · `GET/PUT /billing/reports/filters` @ `479995e` · FE wire ❌ P2 | REQUIREMENTS · ROADMAP P2 · TWR 302 gap #4 partial |
| **BNK-491** | **US-E05 API contract △ partial** @ `dffd726` — `getMonthlyAttendanceStats`+`markAbsentApi` 정합 · `/attendance/stats` UI ❌ | USER_STORIES US-E05 · ROADMAP P2 |
| **BNK-491~493** | **4축 가정 번복 0** · 백본 4-URL 289차 zero drift · ezCare home banner 9th rotation(marketing only·ogada impact 0) | PLAN_NOTES carry |
...
|---|------|------|----------|----------|---------|
| 1 | **출석 통계 FE wire** (`/attendance/stats`) | API ✅(`GET /api/v1/attendance/stats/monthly`·BE `560057f`) · FE `@dffd726` **API contract △ partial** · **AttendanceStatsPage UI ❌** | **Q613 기록만** · `yearMonth`/`dailyRates`/`clientStats` 필드 정합 **186차 partial** | **coder** — AttendanceStatsPage 구현·테이블/차트 | **P2** |
...
| 3 | **결석 버튼 UX** (`/attendance` 화면) | API ✅(`POST /api/v1/attendance/absence`·clientId/date) · FE `@dffd726` **`markAbsentApi` wire △ partial** · **버튼·모달 ❌** | **Q94 FAQ 기록만** · Swagger 우회 | **UXD** — 모달·버튼 명세 · **coder** — FE 구현 | **P2** |
| 4 | **청구 필터 저장 API** (월별·조회·인쇄·재발행) | BE **△ partial ✅** @ `479995e`(V170·`GET/PUT /billing/reports/filters`) · FE **`appliedFilters` echo ✅** · **FE persist wire ❌** | **Q601 echo 완료·186차 BE API partial** · FE wire P2 | **coder** — FE `billingReportFilters` persist wire | **P2** |

**coder 다음 액션 (302차·186차 PLN 갱신)**:
1. **출석 통계 FE wire** — `@dffd726` API contract partial → **AttendanceStatsPage** 구현·테이블/차트
2. **QR 이미지 생성** — `POST /api/v1/attendance/qr/generate` 응답 base64·PNG 렌더 → 다운로드·모바일 인식 테스트
3. **결석 버튼** — UXD 명세 후 `/attendance` 모달·버튼 추가
4. **청구 필터 저장 FE wire** — BE `@479995e` `GET/PUT /billing/reports/filters` → FE persist wire
...
### [TWR] 305차 documentation baseline closure (2026-06-22, 05:00 UTC — **Must docs fully synchronized·QR iamge gap only remaining**)

> **상태**: ✅ **305차 완료**
> 
> **최근 갱신 (305차)**: **ops 문서 최종 안정화** — `CHANGELOG`·`USER_MANUAL`·`ADMIN_GUIDE`·`FAQ`·`DEPLOYMENT_GUIDE` **304차 전수 반영 완료** · **baseline** `BE 99d03fa...`/`FE 77b1ea8` · **V1–V170·109 route·87 page·모듈 KPI 78.79%·merge gate 665**
>
> ✅ **ops 문서 305차 최종 안정화 완료**:
> - **CHANGELOG.md** — 304차 Unreleased block **완전 반영** · **G-BILLING-REPORT-FILTER-PERSISTENCE full-stack ✅** · **G-STAFF-WORK-ATTENDANCE checkout guard ✅** · **UXD-152 a11y ✅** · **V170·V171 integrity**
> - **USER_MANUAL.md** — **§1-3·§1-5·§4-6·§5-3** — **청구 필터 자동저장·직원 출근방식·퇴근 guard·a11y** · **304차 Must 기능 통합**
> - **ADMIN_GUIDE.md** — **§1-4·§6-2-20·§6-2-23** — **BillingReportFilterService·StaffWorkAttendanceService·UXD-152**
> - **FAQ.md** — **Q618·Q621 closure·Q622·Q623 신규** — **청구 필터 persistence·직원 퇴근 guard·a11y**
> - **DEPLOYMENT_GUIDE.md** — **§1-3·§1-4** · V170·V171·baseline submodule
> - **README.md** — baseline carry
>
> **Must 기능 문서화 상태**:
> | Must 카테고리 | 함수 | 상태 | 문서 | 남은 갭 |
> |-------------|------|------|------|--------|
> | **G1–G3 출석** | `GET /attendance`, `POST /attendance/absence` | ✅ | USER_MANUAL §4-2, §4-4 | **Q590/Q616: QR 이미지만 pending** |
> | **G14–G17 간호·기능회복** | `GET /programs/functional-recovery`, CMS API | ✅ | USER_MANUAL §5-4 | 0 |
> | **G21 방문요양** | `GET/POST /visits/batch-confirm`, NHIS sync | ✅ | USER_MANUAL §3, FAQ Q570 | 0 |
> | **G26–G32 케어/사례관리** | `GET /case-management`, assessment per-spec | ✅ | USER_MANUAL §5-5·§5-6, FAQ Q568 | 0 |
> | **G-BILLING·청구** | `GET/PUT /billing/reports/filters`, ledger 4-channel | ✅ | USER_MANUAL §4-6, FAQ Q571/Q621 | 0 |
> | **G-CASH-RECEIPT** | `POST /billing/cash-receipts`, NTS issuance | ✅ | USER_MANUAL §5-10, FAQ Q537 | **NTS API (P3) · tax deduction export (P3)** |
> | **G15 배차·Kakao** | `GET /transports`, real-time dispatch | ✅ | USER_MANUAL §3-7, FAQ Q425+ | 0 |
> | **G-STAFF-WORK-ATTENDANCE** | `GET/POST /staff/work-attendance/check-*` | ✅ | USER_MANUAL §4-5, FAQ Q612/Q622 | 0 |
> | **UXD-152 a11y** | aria-label, role, aria-busy | ✅ | ADMIN_GUIDE §6-2-23, FAQ Q623 | 0 |
> | **QR 셀프 체크인** | `POST /attendance/qr`, image generation | ❌ **Must 유일 잔존** | FAQ Q590/Q616 | **Q590: payload 정의·Q616: 이미지 생성** |
>
> **다음 문서화 우선순위 (306차+)**:
> 1. **QR 생성 payload·이미지** (Q590/Q616) — `coder` 구현 후 `POST /attendance/qr` payload·response 갱신
> 2. **G-CASH-RECEIPT-NTS-API** P3 — 홈택스 실연동 API 자동발급 flow 문서화 (법정 의무)
> 3. **L03_M15 말기 돌봄 호스피스** — 5번째 간호급여 모듈
> 4. **7-5 live payment gateway** — 카드·카카오페이 실결제 flow (stub→live migration)
...
#### #174. V171 후속 앱 only · G-BILLING-DEPOSIT-ORDER-GUARD · V171 readiness probe · 신규 V172 불요 (2026-06-22, round 186, backend `9db0bbb`)
- **배경**: round 185(#173 — V169/V170 coder 신규 + V171 DBA defense-in-depth, backend `479995e`) → backend HEAD **`9db0bbb`** 7 commit 전진 — `6be0c79` **V171 commit**·`35e6c52` `StaffWorkAttendanceService` checkout-before-checkin 서비스 가드·`fd0a3b3`/`99d03fa` `BillingReportFilterService` autosave write-scope/non-blocking read·`dce9bf1`/`175d9cb` **V171DefenseInDepthSchemaReadinessProbe** + `HealthController`/`LiveE2eController` operation readiness gate·`9db0bbb` CMS enrollment input normalization.
- **`git diff --name-only 479995e..9db0bbb -- src/main/resources/db/migration/`** = **`V171__staff_work_attendance_and_billing_report_filters_integrity.sql` 1파일**(round 185 DBA 산출, `6be0c79` commit). `git diff 479995e..9db0bbb | grep -iE 'CREATE TABLE|ALTER TABLE|@Entity|@Column|@Table'`(V171 제외) = **0건**.
- **G-BILLING-DEPOSIT-ORDER-GUARD DB backing** (신규 인덱스 0건): `BillingService.assertPriorDepositOrderForClients` / `assertCopayDepositOrder` — ① `billingClaimRepository.findByOrganizationIdAndBranchIdAndStatusAndYearMonthLessThanOrderByYearMonthAsc(org, branch, CONFIRMED, yearMonth)` → V50 `idx_billing_claims_org_branch_status_year_month` `(organization_id, branch_id, status, year_month)` + V5 `(org, branch, status, year_month DESC)` equality+range prefix ② per older claim `billingClaimItemRepository.findByClaimIdOrderByCreatedAtAsc` → V29 `idx_billing_claim_items_claim_created` ③ `clientIds` 교집합은 **인메모리**. CMS·EasyPay·manual 3-channel 동일 가드 — DB 변경 0건.
- **V171 readiness probe 영향**: `V171DefenseInDepthSchemaReadinessProbe` — `pg_constraint`에서 V171 CHECK/FK 5종 존재만 boolean 노출(읽기 전용). `HealthController.isOperationReady`·`/live-e2e/probe` gate 와이어 — V165/V159/V157 패턴 동일. 신규 테이블·컬럼·인덱스 0건.
- **검증 결과**:
  - `mvn flyway:migrate` (로컬 PG14, dev DB V168→V171) → V169→V170→V171 순서 적용 PASS.
  - `mvn flyway:validate` → **Successfully validated 171 migrations** (V1–V171 contiguous, 갭·중복 0).
  - `pg_constraint` 실측 5종 전부 존재 · SQL negative(퇴근<출근 `chk_staff_work_attendance_checkout_not_before_checkin`·공백 search_query `chk_billing_report_filters_search_query_nonempty`)·positive(유효 INSERT) PASS.
- **Must billing·attendance·NHIS 핵심 제약 7건** SQL 물리 재확인 → **전부 불변**. agents.yaml `core_entities` 11종 전수 충족.
- **`ls db/migration | wc -l` = 171** contiguous(V1–V171, 갭·중복 0).
- **결론**: **신규 V172 불요**. ERD §1 round 186+·§7 본 검증 헤더·메타 timestamp 갱신. **보류 carry**(전 라운드 동일): V169 same-day cross-row overlap(P3)·V166 `is_active` pairing(P3)·V162 `branch_ids` 요소 UUID(P3)·현금영수증 cross-table/time(P2)·PLAN↔BILLING reciprocal(P2)·`billing_payments`(Epic L). **coder**: 추가 DDL 0건 — `mvn flyway:migrate`(V169–V171 미적용 환경)·관련 billing/staff 테스트 재검증 권장.

#### #173. V169 G-STAFF-WORK-ATTENDANCE · V170 G-BILLING-REPORT-FILTERS 신규 + V171 defense-in-depth integrity (2026-06-22, round 185, backend `479995e`)
- **배경**: round 184(#172 — V167/V168 overdue CRM, backend `b583c11`) → backend HEAD **`479995e`** — coder 가 **V169 `staff_work_attendance`**(`560057f` G-STAFF-WORK-ATTENDANCE)·**V170 `billing_report_filters`**(`479995e` G-BILLING-REPORT-FILTER-PERSISTENCE) 2건을 develop 에 적재. DBA 가 V168 패턴으로 **V171 defense-in-depth** 1건 산출.
- **V169 검토 (coder 소유 — DBA confirmation)**: UK `(org, branch, user, work_date)`·method enum CHECK·`chk_*_checkout_after_checkin`(pairing)·`updated_at >= created_at`·복합 Tenant FK 3종(user_org·branch_org·**user_branch_assignment**). **갭**: `check_out_at >= check_in_at` 시각 순서 미강제 → **V171 ①** closure.
- **V170 검토 (coder 소유 — DBA confirmation)**: variant/year_month/deposit_period/receipt_basis enum CHECK·scope UK·조회 인덱스. **갭**: Tenant FK pair 0건·temporal CHECK 0건·`search_query` nonempty CHECK 0건 → **V171 ②** closure.
- **DBA 신규 V171** — single-additive `ALTER TABLE` only:
  - `chk_staff_work_attendance_checkout_not_before_checkin`
  - `chk_billing_report_filters_updated_after_created` + `chk_billing_report_filters_search_query_nonempty`
  - `fk_billing_report_filters_branch_org` + `fk_billing_report_filters_user_org`
- **의도적 제외**: billing_report_filters 3-way `user_branches` FK(`hq_admin` 전 지점 열람)·user purge index(ephemeral UI preference).
- **검증 결과**: 로컬 PG14 V1–V171 contiguous 적용 PASS · 3 CHECK + 2 Tenant FK 실측 · negative/positive SQL PASS.
- **결론**: V171 신규 1건. ERD §1 Must coverage `attendance`/`billing` 행·§4·§7·§8·DATA_RETENTION §3 갱신. **coder**: `StaffWorkAttendanceService`·`BillingReportFilterService` 정상 경로 영향 0.
...
#### [PLN] G34-WORKFLOW-CATALOG — 운영주기별 워크플로 FAQ cross-walk (2026-06-22, 187차 — BNK-507 · **신규 candidate · 「가정」 P3**)

- **근거**: ezCare FAQ 21795–21828 28-건(일일/수시·주간·월간·분기·반기·연간·비정기) ↔ ogada **15/28 = 53.6% verbatim 인용** · 미인용 13건(일일 라운딩·급여계획 변경·급여제공기록지·관리자 방문일정·직원회의·분기 직원복지·반기 결과평가 모니터링 등).
- **현황**: ogada `ClientFaq21824LifecyclePanel`·`StaffLifecyclePanel` 등 15건 ✅ · **주기별 통합 카탈로그 UI ❌**.
- **검토 질문**: MVP 범위 포함 여부 — **planner 권고(추측·미확인)**: **P3 backlog·v3.1 compliance UX·MVP out-of-scope** · 8건 FAQ 인용 보강 후보(P3 deepen).

#### [PLN] G30-LEGEND — 공단 평가지표 ↔ 자가진단 item MAP (2026-06-22, 187차 — BNK-507 · **신규 candidate · 「가정」 P3**)

- **근거**: ezCare FAQ 21836–21842 = 공단 평가지표 1-15 정본 · ogada `MonitoringItemCatalog` 15-template + 직접 매핑 2건(자가진단 #6↔15·유선상담 #15↔12-14) · **순서 일치 ❌**.
- **현황**: G30 self-diagnosis+integrated checklist ✅ · **평가지표 번호 cross-walk MAP·legend UX ❌**.
- **검토 질문**: G30 UX에 legend/MAP 노출 여부 — **planner 권고(추측·미확인)**: **P3 backlog·평가 준비 UX 개선·KPI 영향 0**.
