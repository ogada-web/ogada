...
> **작성**: planner 에이전트  
> **최초 작성일**: 2026-06-03  
> **최종 갱신**: 2026-06-06 (벤치마크 3차 조사 반영 — G8·NHIS `처리상태`·롱텀2026)  
...
| **이지케어** | 민간 ERP (웹 SaaS + **EZCARE 모바일 앱**) | ✅ 지원·확대 | 공단 일정 엑셀 import + **RFID 점검(방문 중심)** + **재무회계·세무·4대보험** 통합; 보호자 **초대·명세 조회**(EZCARE) | **9,210** 재가기관(2026.06.06) / 상담 |
| **엔젤시스템** | 민간 ERP (웹 + 직원 앱) | ✅ 지원 | **CMS 본인부담 자동이체**(월 **30,000원**+건당 수수료) + 평가·필수교육·온라인 비대면 가입 | 상담 |
...
| G2 | **CMS·간편결제** (본인부담 자동이체) | 케어포·엔젤 ✅ (엔젤 CMS 월 30,000원+건당) | ❌ MVP 제외 | **v2** |
...
| G7 | 공단 엑셀 **컬럼 스펙** 실측·**`처리상태` 선행열** | 업계 공통 (케어포 [44438](https://www.carefor.co.kr/cs/view_notice.php?calmgno=44438)) | △ 가정 — 파서 **스킵·정규화** Must | **즉시** (파일럿 센터 샘플 — PLAN_NOTES #27) |
