...
<head>
  ...
  <link rel='stylesheet' href='/css/web_style.css?date=v_20260427' type='text/css'>
  <link rel='stylesheet' href='/css/frame.css' type='text/css'>
  <link rel="stylesheet" type="text/css" href="/css/content.css?date=v_20260427_1" />
...
<!--	<link rel='stylesheet' href='/css/web.css?date=--><!--' type='text/css'/>-->
  ...
  <script type="text/javascript" src="/js/window_size.js?date=v_20260427"></script>
  <script type="text/javascript" src="/js/validation.js?date=v_20260427"></script>

  <!-- 2023.10.18 added by thPark layer 띄우기 관련 css 및 js -->
  <link rel="stylesheet" type="text/css" href="/css/layer.css" />
  <link rel="stylesheet" type="text/css" href="/css/style_common.css?date=v_20260427" /><!-- less compile file : lessc style_common.less > style_common.css  -->
  <link rel="stylesheet" href="/js/jquery.scrollbar-gh-pages/jquery.scrollbar.css" /><!-- 2022.03.28 added by thPark jquery scrollbar -->
  <link rel="stylesheet" href="/css/img_checkbox.css?date=v_20260427" type="text/css"><!-- ksyun 20180503 -->
  <link rel="stylesheet" href="/css/img_radio.css?date=v_20260427" type="text/css"><!-- ksyun 20200107 -->

  <script type="text/javascript" src="/js/ctlLayer.js?date=v_20260427"></script>
  ...
  <!-- plupload 사진업로드 for Tae-hyung -->
    ...
    function linkInzi()
    {
        $.post("/share/exe/inzi/link.inzi.exe.php", {}, function(data1) {
            $.post("/share/exe/inzi/login.inzi.exe.php", {}, function(data2) {
                var param = $.parseJSON( data2 );
                openInzi(param);
            });
        });
    }

    function openInzi(param)
    {
        var thisForm = $("#openInziFrm");
        thisForm.find("input[name=center_mgno]").val( param['center_mgno'] );
        thisForm.find("input[name=center_manager_yn]").val( param['center_manager_yn'] );
        thisForm.find("input[name=auth_key]").val( param['auth_key'] );
        thisForm.submit();
    }
...
<form id="openInziFrm" name="openInziFrm" action="https://inzi.carefor.co.kr/webapi/carefor_mamber_login" method="POST" target="_blank">
  <input type="hidden" name="center_mgno">
  <input type="hidden" name="center_manager_yn">
  ...
  <div id="m_gnb" class="side_menu" style="display:none;">
    ...
    <div id="lnb">
        ...
        <ul class="subm" style="display:none;">
                    <li onClick="location.href='/intro_si/flowchart.php'">프로그램 사용안내</li>
        ...
        <ul class="subm" style="display:none;">
                    <li onClick="location.href='/daycare/flowchart.php'">프로그램 사용안내</li>
        ...
        <ul class="subm" style="display:none;">
                    <li onClick="location.href='/intro_visit/flowchart.php'">프로그램 사용안내</li>
        ...
        <ul class="subm" style="display:none;">
                    ...
                    <li onClick="location.href='/addservice/recruit_inzicare.php'">놀이마당 강사모집</li>
                    ...
                    <li onclick="window.open('https://jetprice.cafe24.com/index.html');">쇼핑몰</li>
                  </ul>
        ...
        <ul class="subm" style="display:none;">
                    ...
                    <li onClick="location.href='/cs/getting_started.php'">처음사용안내</li>
                  </ul>
  ...
  <header class="header">
    ...
    <div id="submenu" class="sub_drop">
      <div class="sub_drop_w">
        ...
        <div class="sub_div2">
          <li>
            <a href="/intro_si/flowchart.php">프로그램 사용안내</a><br>
...
<!--            <a href="/intro_si/monitoring.php">모니터링 지원</a><br>-->
          ...
          <li>
            <a href="/daycare/flowchart.php">프로그램 사용안내</a><br>
...
<!--            <a href="/daycare/monitoring.php">모니터링 지원</a><br>-->
          ...
          <li>
            <a href="/intro_visit/flowchart.php">프로그램 사용안내</a><br>
...
<!--            <a href="/advertise/join_list.php">회원가입 현황</a>-->
  ...
  <main>
          ...
          <div class="path_w">
            ...
            <div class="p_name1">
              <a class="dropdown-toggle"  data-bs-toggle="dropdown" aria-expanded="false" href="#" role="button">주야간보호급여</a>
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                  <li ><a class="dropdown-item" href="/intro_si/flowchart.php">시설급여</a></li>
                                  <li class="over"><a class="dropdown-item" href="/daycare/flowchart.php">주야간보호급여</a></li>
                                  ...
                                  <li ><a class="dropdown-item" href="/demo/demo.php">고객센터</a></li>
                                  <li ><a class="dropdown-item" href="/mypage/user_modify.php">마이페이지</a></li>
                              </ul>
            </div>
            <div class="p_name2">
              <a class="dropdown-toggle"  data-bs-toggle="dropdown" aria-expanded="false" href="#" role="button">주요프로그램 구성</a>
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                  <li ><a class="dropdown-item" href="/daycare/flowchart.php">프로그램 사용안내</a></li>
                                  <li class="over"><a class="dropdown-item" href="/daycare/func.php">주요프로그램 구성</a></li>
                                  <li ><a class="dropdown-item" href="/daycare/appraisal.php">공단 평가항목 지원</a></li>
                                  <li ><a class="dropdown-item" href="/daycare/composition.php">주야간급여 프로그램 소개</a></li>
                              </ul>
            </div>
                      </div>
        </div>
...
<!-- Modal -->
<div class="modal fade web" id="mapp_adroid" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog modal-w_800">
  <div class="modal-content">		
      <div class="layertitle_div">안드로이드 케어포앱(APP)  설치 안내
        <div class="popup_close cr" type="button" data-bs-dismiss="modal"></div>
      </div>
      <div class="modal-body setapp_pic_size"><img src="/img/settup_mapp_adroid.gif" /> </div>
      <div class="btn_area">
      	<button type="button" class="btn_blue w30p" onclick="window.open('https://play.google.com/store/apps/details?id=kr.co.carefor')">케어포앱 설치하기</button>
        <button type="button" class="btn_gray w30p" data-bs-dismiss="modal">창닫기</button>
      </div>
...
<div class="modal fade web" id="mapp_apple" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog modal-w_800">
  <div class="modal-content">		
      <div class="layertitle_div">애플 케어포앱(APP)  설치 안내
        <div class="popup_close cr" type="button" data-bs-dismiss="modal"></div>
      </div>
      <div class="modal-body setapp_pic_size"> <img src="/img/settup_mapp_apple.gif" /> </div>
      <div class="btn_area">
      	<button type="button" class="btn_blue w30p" onclick="window.open('https://apps.apple.com/kr/app/%EC%BC%80%EC%96%B4%ED%8F%AC/id1220736809')">케어포앱 설치하기</button>
        <button type="button" class="btn_gray w30p" data-bs-dismiss="modal">창닫기</button>
      </div>
...
<div class="modal fade web" id="tapp_adroid" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog modal-w_800">
  <div class="modal-content">		
      <div class="layertitle_div">안드로이드 케어포앱(APP)  설치 안내
        <div class="popup_close cr" type="button" data-bs-dismiss="modal"></div>
      </div>
      <div class="modal-body setapp_pic_size"> <img src="/img/settup_tapp_adroid.gif" /> </div>
      <div class="btn_area">
      	<button type="button" class="btn_blue w30p" onclick="window.open('https://play.google.com/store/apps/details?id=com.hangang.carefor_tablet')">케어포앱 설치하기</button>
        <button type="button" class="btn_gray w30p" data-bs-dismiss="modal">창닫기</button>
      </div>
...
<div class="modal fade web" id="fapp_adroid" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog modal-w_800">
  <div class="modal-content">		
      <div class="layertitle_div">안드로이드 케어포앱(APP)  설치 안내
        <div class="popup_close cr" type="button" data-bs-dismiss="modal"></div>
      </div>
      <div class="modal-body setapp_pic_size"> <img src="/img/settup_fapp_adroid.gif" /> </div>
      <div class="btn_area">
      	<button type="button" class="btn_blue w30p" onclick="window.open('https://play.google.com/store/apps/details?id=com.hangang.carefor_family')">케어포앱 설치하기</button>
        <button type="button" class="btn_gray w30p" data-bs-dismiss="modal">창닫기</button>
      </div>
...
<div class="modal fade web" id="fapp_apple" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog modal-w_800">
  <div class="modal-content">		
      <div class="layertitle_div">애플 케어포앱(APP)  설치 안내
        <div class="popup_close cr" type="button" data-bs-dismiss="modal"></div>
      </div>
      <div class="modal-body setapp_pic_size"> <img src="/img/settup_fapp_apple.gif" /> </div>
      <div class="btn_area">
      	<button type="button" class="btn_blue w30p" onclick="window.open('https://apps.apple.com/us/app/%EA%B0%80%EC%A1%B1%EB%8F%8C%EB%B4%84/id1570365791')">케어포앱 설치하기</button>
        <button type="button" class="btn_gray w30p" data-bs-dismiss="modal">창닫기</button>
      </div>
...
<!-- Modal -->
<div class="sub_title">주요프로그램 구성</div>
<div class="sub_gray_bg">
  <div class="sub_contitle" data-aos="fade-up">케어포 주야간보호급여 프로그램  구성</div>
  <div class="service_fucn1" data-aos="fade-up">
    <div class="box">
      <div class="pic"><img src="/img/funcpic1.svg"/></div>
      <div class="txt">PC</div>
    </div>
    <div class="divide"></div>
    <div class="box">
      <div class="pic"><img src="/img/funcpic2.svg"/></div>
      <div class="txt">직원 모바일앱</div>
    </div>
    <div class="divide"></div>
    <div class="box">
      <div class="pic"><img src="/img/funcpic3.svg" align="absmiddle"/></div>
      <div class="txt">직원 태블릿앱</div>
    </div>
    <div class="divide"></div>
    <div class="box">
      <div class="pic"><img src="/img/funcpic4.svg"/></div>
      <div class="txt">보호자앱</div>
    </div>
  </div>
  <div class="sub_contxt3" data-aos="fade-up">월 기본사용료에 모두 포함되어 제공되고 있습니다.</div>
  <div class="sub_contxt" data-aos="fade-up">다양한 기기를 통한 케어포 프로그램 사용을 지원해드리고 있습니다.</div>
  <div class="sub_contxt2" data-aos="fade-up">※ 각 기기별 최소 하드웨어사양 및 OS 버전을 확인해주시기 바랍니다.  </div>
</div>
<div class="service_fucn2">
  <div class="box" data-aos="fade-up">
    <div class="c1">pc - 1.수급자관리</div>
    <div class="c2">
      1-1.수급자 정보관리<br /><!--1-1.수급자 정보관리-->
      1-1-1.대기 수급자 관리<br /><!--1-1-1.대기 수급자 관리-->
      1-2.전체 기초평가 현황<br /><!--1-2.전체 기초평가 현황-->
      1-3.기초평가 관리<br /><!--1-3.기초평가 관리-->
      1-4.상담일지<br /><!--1-4.상담일지-->
      1-5.가정통신문<br /><!--1-5.가정통신문-->
      1-6.수급자 안내사항/예방접종<br /><!--1-6.수급자 안내사항/예방접종-->
      1-7.수급자 현황 리포트<br /><!--1-7.수급자 현황 리포트-->
      1-8.수급자 월별 통계 리포트<br /><!--1-8.수급자 월별 통계 리포트-->
      1-9.수급자 등급 변동 현황<br /><!--1-9.수급자 등급 변동 현황-->
      1-10.연계기록지 발송 리포트<!--1-10.연계기록지 발송 리포트-->
    </div>
  </div>
  <div class="box" data-aos="fade-up">
    <div class="c1">pc - 2.이동서비스관리</div>
    <div class="c2">
      2-1.일정관리(공단연동)<br /><!--2-1.일정관리(공단연동)-->
      2-1-1.외출 관리<br /><!--2-1-1.외출 관리-->
      2-2.탑승관리(차량 이용)<br /><!--2-2.탑승관리(차량 이용)-->
      2-3.출석관리(차량 미이용)<br /><!--2-3.출석관리(차량 미이용)-->
      2-4.차량관리<br /><!--2-4.차량관리-->
      2-5.청구내역상세(공단연동)<br /><!--2-5.청구내역상세(공단연동)-->
      2-6. 공단 입퇴소내용 자료(공단연동)<br /><!--2-6.공단 급여비용 청구 자료(공단연동)-->
      2-7.월간 서비스 변동현황<br /><!--2-7.월간 서비스 변동현황-->
      2-8.월간 입소자, 일정, 서비스 현황<br /><!--2-8.월간 입소자 현황-->
      2-9.수급자 외출 리포트<!--2-9.수급자 외출 리포트-->
    </div>
  </div>
  <div class="box" data-aos="fade-up">
    <div class="c1">pc - 3.요양 급여제공</div>
    <div class="c2">
      3-1.요양급여 제공 기록<br /><!--3-1.요양급여 제공 기록-->
      3-1-1.통합식사도움기록<br /><!--3-1-1.통합식사도움기록-->
      3-1-2.간호급여 제공기록(바이탈,투약)<br /><!--3-1-2.간호급여 제공기록(요양보호사)-->
      3-1-3.요양급여 특이사항 관리<br /><!--3-1-3.요양급여 특이사항 관리-->
      3-1-4.식사(간식) 만족도 조사 및 반영<br /><!--3-1-4.식사(간식) 선호도 조사 및 반영-->
      3-2.상태변화 기록<br /><!--3-2.상태변화 기록-->
      3-3.목욕일정 및 제공현황<br /><!--3-3.목욕일정 및 제공현황-->
      3-4.요양/식사(조치사항)/화장실 리포트<br /><!--3-4.요양/식사(조치사항)/화장실 리포트-->
      3-5.목욕도움 리포트<br /><!--3-5.목욕도움 리포트-->
      3-6.급여제공 리포트<br /><!--3-6.급여제공 리포트-->
      3-7.급여제공 서비스 집계<!--3-7.급여제공 서비스 집계-->
    </div>
  </div>
  <div class="box" data-aos="fade-up">
    <div class="c1">pc - 4.간호/물리(작업) 급여제공</div>
    <div class="c2">
      4-1.간호급여 제공기록(간호,투약,진료)<br /><!--4-1.간호급여 제공기록(간호,투약,진료)-->
      4-1-1.통합 간호관리 기록<br /><!--4-1-1.통합 바이탈 기록-->
      4-2.응급상황 기록(필요시)<br /><!--4-2.응급상황 기록-->
      4-3.통합 간호제공 리포트<br /><!--4-3.통합 간호제공 리포트-->
      4-4.병의원 진료내역 리포트<br /><!--4-4.병의원 진료내역 리포트-->
      4-5.투약제공 리포트<br /><!--4-5.투약제공 리포트-->
      4-6.물리/작업치료 제공기록(필요시)<br /><!--4-6.물리(작업)치료 제공기록-->
      4-6-1.물리(작업)치료 일정<br /><!--4-6-1.물리(작업)치료 일정 -->
      4-6-2.물리(작업)치료 제공 리포트<br /><!--4-6-2.물리(작업)치료 제공 리포트-->
      4-6-3.물리(작업)치료 일정 리포트<!--4-6-3.물리(작업)치료 일정 리포트-->
    </div>
  </div>
  <div class="box" data-aos="fade-up">
    <div class="c1">pc - 5.프로그램 급여제공</div>
    <div class="c2">
      5-1.프로그램 제공기록<br /><!--5-1.프로그램 제공기록-->
      5-1-1.외부강사/자원봉사자 관리<br /><!--5-1-1.외부강사/자원봉사자 관리-->
      5-2.프로그램 일정관리<br /><!--5-2.프로그램 일정관리-->
      5-3.프로그램 수급자 그룹 설정(필요시)<br /><!--5-3.프로그램 수급자 그룹 설정(필요시)-->
      5-3-1.프로그램 그룹 관리<br /><!--5-3-1.프로그램 그룹 관리-->
      5-4.프로그램 정보관리<br /><!--5-4.프로그램 정보관리-->
      5-5.프로그램 의견수렴 및 반영<br /><!--5-5.프로그램평가(의견수렴)-->
      5-5-1.프로그램관리자 업무수행일지<br /><!--5-5-1.프로그램관리자 업무수행일지-->
      5-6.프로그램 계획<br /><!--5-6.프로그램 콘텐츠-->
      5-7.수급자 참여프로그램 리포트<br /><!--5-7.수급자 참여프로그램 리포트-->
      5-8.프로그램 제공기록 리포트(운영기록지)<br /><!--5-8.프로그램 제공기록 리포트(운영기록지)-->
      5-9.프로그램 수급자 그룹 설정 이력 리포트<br /><!--5-9.프로그램 수급자 그룹 설정 이력 리포트-->
      5-10.수급자 프로그램 일정 리포트<!--5-10.수급자 프로그램 일정 리포트-->
    </div>
  </div>
  <div class="box" data-aos="fade-up">
    <div class="c1">pc - 6.위생.안전 점검관리</div>
    <div class="c2">
      6-1.주간식단표<br /><!--6-1.주간식단표-->
      6-2.일일점검<br /><!--6-2.일일점검-->
      6-3.정기점검<br /><!--6-3.정기점검-->
      6-3-1.감염병 관리<br /><!--6-3-1.감염병 관리-->
      6-4.시설운영일지<!--6-4.시설운영일지-->
    </div>
  </div>
  <div class="box" data-aos="fade-up">
    <div class="c1">pc - 7.본인부담금관리</div>
    <div class="c2">
      7-1.본인부담금 청구관리<br /><!--7-1.본인부담금 청구관리-->
      7-2.본인부담금 입금관리<br /><!--7-2.본인부담금 입금관리-->
      7-2-1.의료비공제(연말정산)<br /><!--7-2-1.의료비공제(연말정산)-->
      7-3.본인부담금 미납관리<br /><!--7-3.본인부담금 미납관리-->
      7-4.본인부담금 자동이체 (CMS)<br /><!--7-4.본인부담금 자동이체 (CMS)-->
      7-5.본인부담금 간편결제<br /><!--7-5.본인부담금 간편결제-->
      7-6.본인부담금 청구대장 리포트<br /><!--7-6.본인부담금 청구대장 리포트-->
      7-7.본인부담금 입금대장 리포트<br /><!--7-7.본인부담금 입금대장 리포트-->
      7-8.본인부담금 수납대장 리포트<br /><!--7-8.본인부담금 수납대장 리포트-->
      7-9.본인부담금 수납,환불내역<br /><!--7-9.본인부담금 수납,환불내역-->
      7-10.본인부담금 간편계산기<!--7-10.본인부담금 간편계산기-->
    </div>
  </div>
  <div class="box" data-aos="fade-up">
    <div class="c1">pc - 8.직원관리</div>
    <div class="c2">
      8-1.직원 정보관리<br /><!--8-1.직원 정보관리-->
      8-1-2.선임 요양보호사 업무수행일지<br /><!--8-1-1.선임 요양보호사 업무수행일지-->
      8-2.근무일정표<br /><!--8-2.근무일정표-->
      8-3.연간 일정계획<br /><!--8-3.연간 일정계획-->
      8-4.출퇴근 및 근무관리<br /><!--8-4.출퇴근 및 근무관리-->
      8-5.사례관리 회의록<br /><!--8-5.사례관리 회의록-->
      8-6.회의록(운영위원회)<br /><!--8-6.회의록(보호자,복지및포상)-->
      8-7.교육일지<br /><!--8-7.교육일지(노인인권, 재난, 소화, 직원권익)-->
      8-7-1.요양보호사 보수교육<br /><!--8-7-1.요양보호사 보수교육-->
      8-8.자원봉사자 활동일지(필요시)<br /><!--8-8.자원봉사자 활동일지-->
      8-9.고충처리 관리<br /><!--8-9.고충처리 관리-->
      8-10.건강검진관리<br /><!--8-10.건강검진관리-->
      8-11.질향상노력(삭제예정)<br /><!--8-11.질향상노력-->
      8-12.직원 현황 리포트<br /><!--8-12.현황 리포트-->
      8-13.연차,유급휴일 대장<!--8-13.연차,유급휴일 대장-->
    </div>
  </div>
  <div class="box" data-aos="fade-up">
    <div class="c1">pc - 9.기초설정 및 운영관리</div>
    <div class="c2">
      9-1.시설정보설정<br /><!--9-1.시설정보설정-->
      9-1-1.기초작업 및 기초설정<br /><!--9-1-1.기초작업 및 기초설정-->
      9-2.요양급여 수가설정<br /><!--9-2.요양급여 수가설정-->
      9-3.이용요금 결제 및 연장<br /><!--9-3.이용요금 결제 및 연장-->
      9-4.비품관리대장<br /><!--9-4.비품관리대장-->
      9-5.연간 부담금현황<!--9-5.연간 부담금현황-->
    </div>
  </div>
  <div class="box" data-aos="fade-up">
    <div class="c1">pc - 10.부가서비스</div>
    <div class="c2">
      10-1.문자메시지 발송<br /><!--10-1.문자메시지 발송-->
      10-2.급여제공내역 안내 발송<br /><!--10-2.급여제공내역 안내 발송-->
      10-2-1.수가변경안내 발송<br /><!--10-2-1.수가변경안내 발송-->
      10-3.보호자 급여기록 열람내역<br /><!--10-3.보호자 급여기록 열람내역-->
      10-4.기관 공지사항, 자료실<br /><!--10-4.기관 공지사항, 자료실-->
      10-5.홈페이지 서비스<br /><!--10-5.홈페이지 서비스-->
      10-6.보호자 앱 관리<br /><!--10-6.보호자 앱 관리-->
      10-7.안내발송내역(문자, 이메일)<br /><!--10-7.안내발송내역(문자, 이메일)-->
      10-8.평가항목 및 사전 준비자료 출력<!--10-8.평가항목 및 사전 준비자료 출력-->
    </div>
  </div>
  <div class="box" data-aos="fade-up">
    <div class="c1">pc - 11.직원 급여관리</div>
    <div class="c2">
      11-1. 월별 급여대장<br /><!--11-1. 월별 급여대장-->
      11-2. 퇴직적립금 관리<br /><!--11-2. 퇴직적립금 관리-->
      11-3. 직원 급여계약 설정<br /><!--11-3. 직원 급여계약 설정-->
      11-4. 급여기초 설정(수당/공제)<br /><!--11-4. 급여기초 설정(수당/공제)-->
      11-5. 인건비 지출비율 참고자료<br /><!--11-5. 인건비 지출비율 참고자료-->
      11-6.직원 급여대장 리포트(간이지급명세서)<!--11-6. 직원 급여대장 리포트(간이지급명세서)-->
    </div>
    <div class="c3">
      ※ PC 권장 사양<br />
      - 모니터 : 22인치 이상 (1600x900 이상)<br />
      - 브라우저 : 크롬, 엣지 이상 권장
    </div>
  </div>
  <div class="box2" data-aos="fade-up">
    <div class="c1 bg1">모바일 직원앱</div>
    <div class="c2">
      <div class="txt">
        수급자관리<br />
        기초평가 및 상담일지<br />
    ...
    <div class="c3">
      ※ 모바일앱 권장 사양<br />
      - 안드로이드폰(OS 5.1 이상), 아이폰(iOS 8.0 이상)에서 최적화
    </div>
    <div class="btn_area">
      <div class="btn_gray" data-bs-toggle="modal" data-bs-target="#mapp_adroid" data-backdrop="static" data-keyboard="false" >안드로이드 설치방법</div>
      <div class="btn_gray" data-bs-toggle="modal" data-bs-target="#mapp_apple" data-backdrop="static" data-keyboard="false" >아이폰 설치방법</div>
    </div>
  </div>
  <div class="box2" data-aos="fade-up">
    <div class="c1 bg2">태블릿 직원앱</div>
    <div class="c2">
      <div class="txt">
        신체활동<br />
        인지관리<br />
    ...
    <div class="c3">
      ※ 태블릿앱 권장 사양<br />
      - 안드로이드폰(OS 5.0 이상), 아이폰(iOS 8.0 이상)에서 최적화
    </div>
    <div class="btn_area">
      <div class="btn_gray" data-bs-toggle="modal" data-bs-target="#tapp_adroid" data-backdrop="static" data-keyboard="false">태블릿앱 설치방법</div>
    </div>
  </div>
  <div class="box2" data-aos="fade-up">
    <div class="c1 bg3">보호자앱</div>
    <div class="c2">
      <div class="txt">
        건강정보<br />
        앨범<br />
    ...
    <div class="btn_area">
      <div class="btn_gray" data-bs-toggle="modal" data-bs-target="#fapp_adroid" data-backdrop="static" data-keyboard="false">안드로이드 설치방법</div>
      <div class="btn_gray" data-bs-toggle="modal" data-bs-target="#fapp_apple" data-backdrop="static" data-keyboard="false">아이폰 설치방법</div>
    </div>
  </div>
</div>
...
<!-- Modal -->  
    ...
    <footer>
        ...
        <div class="c2 wordkeep">
          <p class="inline" onclick="fnCopyToClipboard('서울시 동작구 보라매로 5길 35 파크스퀘어 7층')">우)07071 서울시 동작구 보라매로 5길 35 파크스퀘어 7층</p>
          <p class="inline">고객센터. <a href="tel:1544-8691">1544-8691</a></p>
          <p class="inline">팩스. 02-6008-2514</p>
          <p class="inline">이메일. help@carefor.co.kr </p>
          <p class="inline">대표자. 박 채 규</p>
          <p class="inline">사업자등록번호.120-81-57465 </p>
          <p class="inline">통신판매업 신고번호. 제02-680-327호</p>
          <p class="inline">제휴협력. contract@hangang.com</p>
        </div>
      </div>
    </footer>
</div>
